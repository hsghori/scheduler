...
let { createForm } = require('./constants');
...
function commit() {
    ...
    const peopleList = $(FORM_CONTAINER).children('.individual-form').toArray().map(
        form => getPerson($(form))
    );
...
},{"./constants":1,"./schedule":6,"jquery":3,"styledot/loading":5}],3:[function(require,module,exports){
/*!
